...
static void miniuart_hex_dump(unsigned int value) {
	char buf[9];
...
void miniuart_settings_dump(void) {
	miniuart_puts("AUX_ENABLES: ");
	miniuart_hex_dump(*((volatile unsigned int *)AUX_ENABLES));
	miniuart_puts("\r\n");
	miniuart_puts("LCR: ");
	miniuart_hex_dump(MINIUART->LCR.Raw32);
	miniuart_puts("\r\n");
	miniuart_puts("MCR: ");
	miniuart_hex_dump(MINIUART->MCR.Raw32);
	miniuart_puts("\r\n");
	miniuart_puts("BAUD: ");
	miniuart_hex_dump(MINIUART->BAUD.Raw32);
	miniuart_puts("\r\n");
	miniuart_puts("GPIO: ");
	miniuart_hex_dump(GPIO->GPFSEL[1]);
	miniuart_puts("\r\n");
	miniuart_puts("no other setting\r\n");
}
